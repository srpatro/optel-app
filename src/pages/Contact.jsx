  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-6">संपर्क करें</h1>
        
        <section className="mb-8">
          <p className="text-gray-700 mb-4">
            हम आपकी सहायता के लिए यहां हैं। यदि आपके कोई प्रश्न, सुझाव या चिंताएं हैं, तो कृपया हमसे संपर्क करने में संकोच न करें।
          </p>
        </section>
